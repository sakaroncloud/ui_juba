...
import {
  ...
  Gender,
  Role,
  StaffWithNoSuperAdminRole,
} from "@repo/ui/types/user.types";
...
export const changePasswordSchema = z
  .object({
    ...
    newPassword: z
      ...
      .regex(/^(?!.*(?:password|1234|qwerty|admin)).*$/, {
        message:
          "Password cannot contain common words or patterns like 'password', '1234', or 'qwerty'.",
      }),
...
export const staffProfileSchema = profileBasicSchema.merge(
  z.object({
...
export const addStaffSchema = z
  .object({
    email: z
      ...
      .trim(),
    role: z.nativeEnum(StaffWithNoSuperAdminRole),
  })
  .merge(profileBasicSchema);
