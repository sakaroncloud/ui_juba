...
import {
  roomGallerySchema,
  TRoomGalleryClientForm,
} from "@repo/ui/schemas/lodging/room/room.gallery.schema";
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <GalleryForm
          ...
          label={"Gallery"}
          fetchEndPoint={
            API_ROUTES.lodging.uploads.singlePropertyImage.endpoint +
            "/" +
            propertyId
          }
          uploadEndPoint={
