...
import {
  parseRoomAmenitiesFromS2C,
  parseRoomGeneralInfoFromS2C,
  parseRoomRulesFromS2C,
...
const RoomEditPage = async ({ params }: Props) => {
  ...
  if (slugTempered || propertyId === undefined || roomId === undefined)
    notFound();
